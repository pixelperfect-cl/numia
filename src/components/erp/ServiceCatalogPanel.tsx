...
import { getServiceDefinitions, deleteServiceDefinition } from '@/lib/firebase/database';
...
export function ServiceCatalogPanel() {
    ...
    const loadData = async () => {
        ...
        setLoading(true);
        try {
            const data = await getServiceDefinitions(user.uid);
            setDefinitions(data);
        } catch (error) {
                    ...
                    <div className="rounded-md border">
                        <Table>
                            ...
                            <TableBody>
                                {loading ? (
                                    <TableRow>
                                        <TableCell colSpan={5} className="text-center py-8">Cargando catálogo...</TableCell>
                                    </TableRow>
